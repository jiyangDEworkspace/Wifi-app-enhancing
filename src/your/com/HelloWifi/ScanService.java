...
public class ScanService extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		//Toast.makeText(this, "scanservice onStart", 0).show();
	...
	public void locating() {
    	...
    	else
    	{
        	...
        	{
        		message += "There is somrthing wrong reading your own database!";
        	...
        	//message += "类别：" + chosenBuildings.name;
